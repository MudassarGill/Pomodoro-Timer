...
A beautifully designed, production-ready Pomodoro Timer web application built with **React**, **Vite**, and **Tailwind CSS**. 

## ✨ Features
- **Customizable Timer:** Change focus and break durations to whatever you want (not just 25 minutes!). Click the "Settings" gear to adjust.
